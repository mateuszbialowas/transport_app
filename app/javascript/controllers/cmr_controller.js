...
export default class extends Controller {
    ...
    save() {
        const sender_1 = document.getElementById("sender_1").innerText;
        const cmr_number = document.getElementById("cmr_number").innerText;
        const consignee_2 = document.getElementById("consignee_2").innerText;
        const carrier_16 = document.getElementById("carrier_16").innerText;
        const carriers_plates_16 = document.getElementById("carriers_plates_16").innerText;
        const delivery_place_3 = document.getElementById("delivery_place_3").innerText;
        const successive_carriers_17 = document.getElementById("successive_carriers_17").innerText;
        const taking_over_place_4 = document.getElementById("taking_over_place_4").innerText;
        const taking_over_date_4 = document.getElementById("taking_over_date_4").innerText;
        const documents_5 = document.getElementById("documents_5").innerText;
        const marks_6_1 = document.getElementById("marks_6_1").value;
        const number_7_1 = document.getElementById("number_7_1").value;
        const method_8_1 = document.getElementById("method_8_1").value;
        const nature_9_1 = document.getElementById("nature_9_1").value;
        const number_10_1 = document.getElementById("number_10_1").value;
        const weight_11_1 = document.getElementById("weight_11_1").value;
        const volume_12_1 = document.getElementById("volume_12_1").value;

        const marks_6_2 = document.getElementById("marks_6_2").value;
        const number_7_2 = document.getElementById("number_7_2").value;
        const method_8_2 = document.getElementById("method_8_2").value;
        const nature_9_2 = document.getElementById("nature_9_2").value;
        const number_10_2 = document.getElementById("number_10_2").value;
        const weight_11_2 = document.getElementById("weight_11_2").value;
        const volume_12_2 = document.getElementById("volume_12_2").value;

        const marks_6_3 = document.getElementById("marks_6_3").value;
        const number_7_3 = document.getElementById("number_7_3").value;
        const method_8_3 = document.getElementById("method_8_3").value;
        const nature_9_3 = document.getElementById("nature_9_3").value;
        const number_10_3 = document.getElementById("number_10_3").value;
        const weight_11_3 = document.getElementById("weight_11_3").value;
        const volume_12_3 = document.getElementById("volume_12_3").value;

        const marks_6_4 = document.getElementById("marks_6_4").value;
        const number_7_4 = document.getElementById("number_7_4").value;
        const method_8_4 = document.getElementById("method_8_4").value;
        const nature_9_4 = document.getElementById("nature_9_4").value;
        const number_10_4 = document.getElementById("number_10_4").value;
        const weight_11_4 = document.getElementById("weight_11_4").value;
        const volume_12_4 = document.getElementById("volume_12_4").value;

        const class_6 = document.getElementById("class_6").value;
        const number_7 = document.getElementById("number_7").value;
        const letter_8 = document.getElementById("letter_8").value;
        const adr_9 = document.getElementById("adr_9").value;
        const sender_instructions_13 = document.getElementById("sender_instructions_13").value;
        const special_agreements_19 = document.getElementById("special_agreements_19").value;
        const carriage_instructions_14 = document.getElementById("carriage_instructions_14").value;
        const carriage_paid_14 = document.getElementById("carriage_paid_14").value;
        const carriage_forward_14 = document.getElementById("carriage_forward_14").value;
        const established_in_21 = document.getElementById("established_in_21").value;
        const established_in_date_21 = document.getElementById("established_in_date_21").value;
        const cash_on_delivery_15 = document.getElementById("cash_on_delivery_15").value;
        ...
        doc.text(21, 35, sender_1);
        doc.text(166, 33, cmr_number);
        doc.text(21, 59, consignee_2);
        doc.text(112, 59, carrier_16);
        doc.text(130, 71.5, carriers_plates_16);
        doc.text(21, 83, delivery_place_3);
        doc.text(112, 83, successive_carriers_17);
        doc.text(21, 107, taking_over_place_4);
        doc.text(70, 107, taking_over_date_4);
        doc.text(21, 122, documents_5);

        // doc.text(21, 139, document.getElementById("6marks1").value);
        // doc.text(50, 139, document.getElementById("7number1").value);
        // doc.text(79, 139, document.getElementById("8method1").value);
        // doc.text(105, 139, document.getElementById("9nature1").value);
        // doc.text(134, 139, document.getElementById("10number1").value);
        // doc.text(157, 139, document.getElementById("11kg1").value);
        // doc.text(180, 139, document.getElementById("12volume1").value);
        //
        // doc.text(21, 146, document.getElementById("6marks2").value);
        // doc.text(50, 146, document.getElementById("7number2").value);
        // doc.text(79, 146, document.getElementById("8method2").value);
        // doc.text(105, 146, document.getElementById("9nature2").value);
        // doc.text(134, 146, document.getElementById("10number2").value);
        // doc.text(157, 146, document.getElementById("11kg2").value);
        // doc.text(180, 146, document.getElementById("12volume2").value);
        //
        // doc.text(21, 153, document.getElementById("6marks3").value);
        // doc.text(50, 153, document.getElementById("7number3").value);
        // doc.text(79, 153, document.getElementById("8method3").value);
        // doc.text(105, 153, document.getElementById("9nature3").value);
        // doc.text(134, 153, document.getElementById("10number3").value);
        // doc.text(157, 153, document.getElementById("11kg3").value);
        // doc.text(180, 153, document.getElementById("12volume3").value);
        //
        // doc.text(21, 160, document.getElementById("6marks4").value);
        // doc.text(50, 160, document.getElementById("7number4").value);
        // doc.text(79, 160, document.getElementById("8method4").value);
        // doc.text(105, 160, document.getElementById("9nature4").value);
        // doc.text(134, 160, document.getElementById("10number4").value);
        // doc.text(157, 160, document.getElementById("11kg4").value);
        // doc.text(180, 160, document.getElementById("12volume4").value);
        //
        // doc.text(25, 184.5, document.getElementById("6class").value);
        // doc.text(54, 184.5, document.getElementById("7number").value);
        // doc.text(85, 184.5, document.getElementById("8letter").value);
        // doc.text(109, 184.5, document.getElementById("9adr").value);
        //
        // doc.text(21, 197, document.getElementById("sendersinstructions").value);
        // doc.text(110, 197, document.getElementById("specialagreements").value);
        //
        // doc.text(57, 234, document.getElementById("carriageinstructions").value);
        // doc.text(67, 238, document.getElementById("carriagepaid").value);
        // doc.text(67, 242, document.getElementById("carriageforward").value);
        //
        // doc.text(38, 248, document.getElementById("establishedin").value);
        // doc.text(76, 248, document.getElementById("datepicker2").value);
        // doc.text(129, 248, document.getElementById("cashondelivery").value);
        ...
        doc.setFont(undefined, "normal")
        doc.setTextColor(1, 1, 1);
        // doc.text(21, 35, document.getElementById("sender_address").value);
        // doc.text(166, 33, document.getElementById("cmrnumber").value);
        // doc.text(21, 59, document.getElementById("consigneename").value);
        // doc.text(112, 59, document.getElementById("carrieraddress").value);
        // doc.text(130, 71.5, document.getElementById("vehiclereg").value);
        // doc.text(21, 83, document.getElementById("deliveryplace").value);
        // doc.text(112, 83, document.getElementById("nextcarriers").value);
        // doc.text(21, 107, document.getElementById("takingoverplace").value);
        // doc.text(70, 107, document.getElementById("datepicker").value);
        // doc.text(21, 122, document.getElementById("documents").value);
        //
        // doc.text(21, 139, document.getElementById("6marks1").value);
        // doc.text(50, 139, document.getElementById("7number1").value);
        // doc.text(79, 139, document.getElementById("8method1").value);
